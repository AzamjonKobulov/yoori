            ...
            <table className="table table-auto w-full min-w-[1280px] text-sm/5 text-left border-y border-base-border">
              <thead className="text-base-muted-foreground">
                <tr className="h-10 bg-base-blue-100 border-b border-base-border divide-x divide-base-border">
                  ...
                  <th className="w-37.5 font-medium px-3.5">Тип</th>
                  <th className="w-55 font-medium px-3.5">Ответственный</th>
                  <th className="w-42.5 font-medium px-3.5">Телефон</th>
                  <th className="w-50 font-medium px-3.5">Почта</th>
                  <th className="w-55 font-medium px-3.5">Контактное лицо</th>
                  <th className="font-medium px-3.5">Описание</th>
                </tr>
              </thead>
              <tbody>
